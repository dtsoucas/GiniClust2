...
#paths
workdir              = "/path/to/GiniClust2/Proj/Project_Folder_Name/"  # where you put the data and results
Rfundir              = "/path/to/GiniClust2/Rfunction/"   # where GiniClust2 R functions are stored
...
k                    = 3 						# k for k-means step
gap_statistic        = TRUE 						# whether the gap statistic should be used to determine k
...
data<-my_data #choose data source; specific format: rownames must be genes, colnames optional
