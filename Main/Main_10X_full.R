...
Rfundir              = "/gcdata/dtsoucas/s1/GiniClust2/Rfunction/"      # where GiniClust2 R functions are stored- here using the computing cluster
...
workdir              = "/gcdata/dtsoucas/s1/GiniClust2/Proj/10X_full/"  # where you put the data and results- here using the computing cluster
